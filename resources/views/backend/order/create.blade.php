                  ...
                  @foreach($data as $key => $row)
                   @foreach(App\Product::where('pro_code',$row->pro_code)->get() as $pro) @endforeach
                      <tr>
                          ...
                          <td class='text-center'>
                              {!! Form::Open(['url'=>'sales/order/remove-cart/'.$row->id]) !!}
        ...
        <div class="col-md-12">
            ...
            <div id="search_result" class="form-group"  style="display:none;height:auto">
                <div class="col-md-12">
                  ...
                  {!! Form::Open(['url'=>'sales/order/add-to-cart']) !!}  
      ...
      {!! Form::Open() !!}
        ...
        <div class="col-md-12" style="margin-top:20px;">
           ...
           <div class="col-md-3 form-group">
              ...
              <input type="date" class="form-control" name="remain_date" required>
           </div>
...
$("#calc_total").on('click',function(){
  var Url = '{{ url("sales/order/calc-total-cart") }}';
...
function submit_qty_{{$jsfun->id}}(id){
  ...
  var Url = "{{ url('sales/order/update-qty/') }}/"+id+'/'+value+'';
