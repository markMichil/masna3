...
<section id="min-wrapper">
  <div id="main-content">
    <div class="container-fluid">
       <div class="row">
          <div class="col-md-12">
          <h3 class="ls-top-header">الفواتير المرتجعة</h3>
              <div class="panel panel-default">
                  <div class="panel-heading">تعديل الفاتورة المرتجعة</div>
...
@endif
      ...
      <div class="col-md-12"><hr></div>
        ...
        @foreach(App\Return_invoice_attribute::where('invoice_id',$getid)->get() as $attr)
           <div>
               <div class='col-md-12'>
                   <br/>
                   <hr>
