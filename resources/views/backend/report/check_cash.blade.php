        ...
        <div class="col-md-12">
          <div class="ls-editable-table table-responsive ls-table">
               ...
               <tbody>
                  ...
                  @foreach($data as $key => $row)
                   @foreach(App\Product::where('pro_code',$row->pro_code)->get() as $pro) @endforeach
                      ...
                      <?php $total_amounts += $row->price*$row->qty; ?>
                  @endforeach
            ...
            <div calss="col-md-4 form-group">
               <p style='font-size:18px;display:block;margin-top:25px;'>{{number_format($total_amounts,2)}} جنيه</p>
            </div>
        ...
        <div class="col-md-12">
            ...
            <div id="search_result" class="form-group"  style="display:none;height:auto">
                <div class="col-md-12">
                    ...
                    <p><label class="label label-success"> الكمية <span id="search_qty"></span></label></p>
                  {!! Form::Open(['url'=>'sales/cash/add/pro']) !!}  
