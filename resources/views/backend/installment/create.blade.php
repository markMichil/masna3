        ...
        <div class="col-md-12">
          <div class="ls-editable-table table-responsive ls-table">
                  ...
                  @foreach($data as $key => $row)
                   @foreach(App\Product::where('pro_code',$row->pro_code)->get() as $pro) @endforeach
                      <tr>
                          ...
                          <td class='text-center'>
                              {!! Form::Open(['url'=>'sales/installment/remove-cart/'.$row->id]) !!}
            ...
            <div calss="col-md-6 form-group">
               <p style='font-size:18px;display:none;margin-top:25px;' id="total_amount"></p><span id="just_amount" style='color:transparent'></span>
            </div>
        ...
        <div class="col-md-12">
            ...
            <div id="search_result" class="form-group"  style="display:none;height:auto">
                <div class="col-md-12">
                  ...
                  {!! Form::Open(['url'=>'sales/installment/add-to-cart']) !!}  
      ...
      {!! Form::Open() !!}
        ...
        <div class="col-md-12" style="margin-top:20px;">
           ...
           <div class="col-md-3 form-group">
              ...
              <input type="number" step="any" id="total" min="0" style="padding:1px;padding-right:10px;" class="form-control" name="total" required>
           </div>

           <div class="col-md-3 form-group">
              <label>المقدم</label>
              <input type="number" step="any" id="paid" min="0" style="padding:1px;padding-right:10px;" onkeyup="calc_remain();" class="form-control" name="paid" required>
           </div>

           <div class="col-md-3 form-group">
              <label>المبلغ المتبقي</label>
              <input type="number" step="any" id="remain" min="0" style="padding:1px;padding-right:10px;" class="form-control" name="remain" required>
           </div>

           <div class="col-md-3 form-group">
              <label>إجمالي مدة القسط</label>
              <input type="number" step="any" min="0" style="padding:1px;padding-right:10px;" class="form-control" name="count" required>
           </div>
        </div>  
        ...
        <div class="col-md-12" style="margin-top:20px;">
           ...
           <div class="col-md-2 form-group">
              ...
              <input type="number" step="any" min="0" style="padding:1px;padding-right:10px;" class="form-control" name="inst_cost" required>
           </div>

           <div class="col-md-3 form-group">
              <label>تاريخ بدأ القسط</label>
              <input type="date" class="form-control" value="{{date('Y-m-d')}}" name="start" required>
           </div>
        ...
        <div class="col-md-12" style="margin-top:60px;">
          <button class="btn btn-primary"><i class="fa fa-check-circle"></i> حفظ الفاتورة</button>
...
$("#calc_total").on('click',function(){
  var Url = '{{ url("sales/installment/calc-total-cart") }}';
...
function submit_qty_{{$jsfun->id}}(id){
  ...
  var Url = "{{ url('sales/installment/update-qty/') }}/"+id+'/'+value+'';
